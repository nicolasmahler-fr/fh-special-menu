 ...
 * of control:
 *
 * - Check if the $_REQUEST['plugin'] content actually is fh-special-menu/fh-special-menu.php
 ...
 * @since 1.0.0
 */
function fh_special_menu_uninstall()
{
	...
	if (
		...
		|| 'fh-special-menu/fh-special-menu.php' !== $_REQUEST['plugin']
